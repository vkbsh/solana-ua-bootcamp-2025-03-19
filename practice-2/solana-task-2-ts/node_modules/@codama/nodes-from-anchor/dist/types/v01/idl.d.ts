...
export type IdlV01Serialization = 'borsh' | 'bytemuck' | 'bytemuckunsafe' | {
    custom: string;
};
...
export type IdlV01GenericArgType = {
    kind: 'type';
    type: IdlV01Type;
};
export type IdlV01GenericArgConst = {
    kind: 'const';
    value: string;
};
export type IdlV01Type = IdlV01TypeArray | IdlV01TypeCOption | IdlV01TypeDefined | IdlV01TypeGeneric | IdlV01TypeNumber | IdlV01TypeOption | IdlV01TypeVec | 'bool' | 'bytes' | 'pubkey' | 'string';
